	...
	<div class="container">
			...
			<div class="col-xs-12 col-sm-12 col-lg-12 col-xl-12">
				...
				<center>
					...
					<h1 class="display-2">Todavía no estas registrado</h1>

					<div class="col-md-6 bg-light py-3" style="border-radius: 30px;">

						<p class="h1">No estas registrado en ActionMovies, te pedimos que lo intentes más tarde en el siguiente link.
						...
						¡No desistas la aventura espera!</p>
